...
def inp():
    ...
    if(len(str(e1)) == 0 or len(str(e2)) == 0):
        errorD = customtkinter.CTkLabel(
            rootE, text_font="Verdana 12", text="Please fill all the required fields (*)", fg_color='red')
        ...
        label_mode = customtkinter.CTkLabel(
            rootE, text_font="Verdana 12", text="Employee Data added", fg_color="green")
...
def delling():
    ...
    if(len(str(de)) == 0):
        error = customtkinter.CTkLabel(
            rootDE, text_font="Verdana 12", text="Please fill all the required fields (*)", fg_color='red')
        ...
        dme = customtkinter.CTkLabel(
            rootDE, text_font="Verdana 12", text="Employee Deleted from database", fg_color="green")
        ...
        error = customtkinter.CTkLabel(
            rootDE, text_font="Verdana 12", text="Employee Doesn't exist", fg_color="red")
        error.pack(side=tkinter.BOTTOM, pady=10)
        error.after(2000, error.pack_forget)
        print("cp2")
